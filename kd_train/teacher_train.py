...
def main(): 
    ...
    if not args.exp_name:
        ...
        exp_name = f'Teacher_seed{args.seed}_{args.dataset_name}_curr{args.use_dynamic_thresh}&0.6_{text_augment_info}_{img_augment_info}'
    else:
    ...
    test_loss, test_acc, test_cider = evaluate(model=teacher,
    ...
    print(f'Before | Test loss: {test_loss}\tTest acc: {test_acc}\Test cider: {test_cider}')
    ...
    best_teacher.load_state_dict(checkpoint['model']) 
