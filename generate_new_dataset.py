from vqa_datasets.augmentations import gpt_paraphraser, mt5_paraphraser
...
def main():
    ...
    if '.csv' in train_filepath:
        if paraphrase_method == 'gpt':
            generate_df_paraphrases_chatgpt(data_filepath=train_filepath,
                                            num_paraphrase=num_params,
                                            save_filepath=save_filepath)
        else:
            generate_df_paraphrases_mt5(data_filepath=train_filepath,
                                        num_paraphrase=num_params,
                                        save_filepath=save_filepath)
