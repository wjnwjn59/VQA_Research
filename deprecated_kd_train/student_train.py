...
from student_config import pipeline_config  # Note changes to suit your method!!!
...
def main(): 
    ...
    if not args.exp_name:
        exp_name = f'Student_AugText_SBERT-30-2:8-3'
    else:
    ...
    student_save_best_path = f'./{weights_dirname}/{exp_name}_student_best.pt'
    
    student = ViVQAModel(projection_dim=args.projection_dim, 
    ...
    checkpoint = torch.load(student_save_best_path,
                        weights_only=True,
    ...
    best_student.load_state_dict(new_state_dict) 
