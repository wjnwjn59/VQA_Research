...
class ImageEncoder(nn.Module):
    def __init__(self, img_model, projection_dim, is_img_augment):
        ...
        self.layer_norm = nn.LayerNorm(self.model.num_features * 7 * 7)
        # self.instance_norm = nn.InstanceNorm1d(self.model.num_features * 7 * 7)  # Instance normalization for flattened features
        # self.batch_norm = nn.BatchNorm1d(self.model.num_features * 7 * 7) 
